...
void add_curve( struct matrix *points, 
    ...
    for (t = 0; t < 1; t += step) {
        x = curveX->m[0][0]*t*t*t +
            curveX->m[1][0]*t*t +
            curveX->m[2][0]*t +
            curveX->m[3][0];
        y = curveY->m[0][0]*t*t*t +
            curveY->m[1][0]*t*t +
            curveY->m[2][0]*t +
            curveY->m[3][0];
        nextX = curveX->m[0][0]*pow(t+step, 3) +
            curveX->m[1][0]*pow(t+step, 2) +
            curveX->m[2][0]*(t+step) +
            curveX->m[3][0];
        nextY = curveY->m[0][0]*pow(t+step, 3) +
            curveY->m[1][0]*pow(t+step, 2) +
            curveY->m[2][0]*(t+step) +
            curveY->m[3][0];
